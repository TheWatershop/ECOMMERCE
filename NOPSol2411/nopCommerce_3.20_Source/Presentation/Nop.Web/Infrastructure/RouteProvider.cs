    ...
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("AddProductToCart-Details",
                            ...
                            new[] { "Nop.Web.Controllers" });
            //Components
            routes.MapLocalizedRoute("AddProductToCart-Components",
                "addproducttocart/details/{productId}/{shoppingCartTypeId}",
                new { controller = "ShoppingCart", action = "AddProductToCart_Components" },
                new { productId = @"\d+", shoppingCartTypeId = @"\d+", ParentItemId = @"\d+" },
                new[] { "Nop.Web.Controllers" });
            //
            ...
            routes.MapLocalizedRoute("CustomerOrders",
                            ...
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CustomerComponents",
                            "customer/components",
                            new { controller = "Customer", action = "Components" },
                            new[] { "Nop.Web.Controllers" });
